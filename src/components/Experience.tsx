  ...
  return (
    <div className="relative">
      ...
      <div className="mb-3 flex items-center gap-2">
        ...
        <p className="text-[15px] font-semibold">{data[0]?.company}</p>
      </div>
      <div className="mb-3 flex items-center gap-2">
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <p className="text-[15px] font-semibold">{data[0]?.position}</p>
      </div>
      <div className="flex items-center gap-2">
        ...
        <p className="text-[15px] font-semibold">{data[0]?.location}</p>
      </div>
    </div>
  );
}
