...
export default function ChapterView({
  ...
  return (
    <Layout>
      <div className="relative mx-auto mt-0 w-full rounded-3xl bg-black/10 pb-8 xl:w-[40vw] 2xl:w-[50vw]">
        <div className="relative h-[400px] w-full rounded-tl-3xl rounded-tr-3xl overflow-hidden">
          <Image
            src={data.image}
            alt={data.name}
            fill
        ...
        <div className="relative mt-4 mb-14 md:mb-0 flex flex-col gap-2 px-4 md:flex-row">
          <div>
