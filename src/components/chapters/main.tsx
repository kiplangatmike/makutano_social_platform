  ...
  return (
    <Layout>
      <div className="relative mx-auto mt-0 w-full pb-6 xl:w-[40vw] 2xl:w-[50vw]">
        <button
          onClick={openModal}
          className="absolute right-0 flex items-center justify-center gap-2 rounded-md bg-white hover:bg-blue-400/25 hover:text-white px-8 py-2 text-base font-semibold text-black"
        >
          <svg
    ...
    >
      ...
      <div className="mt-4 rounded-3xl">
        <Image
          fill
          src={image}
          className=" mx-auto py-11 px-3  rounded-3xl duration-300 ease-in max-w-[230px]  group-hover:scale-[1.05]"
          alt={name}
        />
      </div>
      <div>
